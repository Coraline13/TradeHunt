...
INSERT INTO `listings` (id, type, user_id, title, slug, description, status, added, location_id) VALUES
  (1, 1, 1, 'Rubik cube collection', 'rubik-cube-collection',
   'I have this awesome collection of rubik cubes and I''m willing to give them to a passionate rubik cube master.\n\nIn exchange for them I would appreciate any golden card from the Duel Masters collection.',
  ...
  (6, 1, 1, 'Awesome stamps', 'awesome-stamps',
   'So, as you see in the picture, I have a wonderful stamp collection.\n\nSurprise me with your offers!', 1,
   '2017-10-08 19:16:33', 1);
