 ...
 * specifically for mssql and postgres type files
 * @param string $output sql script
 * @return string comment-less sql script
 */
 ...
 * @return string sql script with no comments
 */
